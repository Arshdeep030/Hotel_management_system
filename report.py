...
class report:
    def __init__(self, root):
        ...
        lbl_Created = Label(labelframeleft, text="Arshdeep Kaur",font=("arial", 12), padx=2, pady=6)
        ...
        lbl_Email = Label(labelframeleft, text="sidhuarshdeep643@gmail.com",font=("arial", 12), padx=2, pady=6)
