...
class Cust_Win:
     ...
     def __init__(self,root):
        ...
        labeling.place(x=5,y=2,width=100 ,height=40)
        ...
        txtmname = ttk.Entry(
            labelframeleft, width=29,textvariable=self.var_mother, font=("arial", 13, "bold"))
        ...
        txtpost = ttk.Entry(
            labelframeleft,width=29,textvariable=self.var_post, font=("arial", 13, "bold"))
        ...
        txtmobile = ttk.Entry(
            labelframeleft,width=29, textvariable=self.var_mobile,  font=("arial", 13, "bold"))
        ...
        txtemail = ttk.Entry(
            labelframeleft, width=29,textvariable=self.var_email,  font=("arial", 13, "bold"))
        ...
        txtadd = ttk.Entry(labelframeleft, width=29,textvariable=self.var_adderss,font=(
            "arial", 13, "bold"))
        ...
        lblsearchby = Label(Tableframe, font=(
            "arial", 12, "bold"), text="Search By: ", bg="#b22222", fg="white")
        lblsearchby.grid(row=0, column=0, sticky=W, padx=2)

        
        combo_Search = ttk.Combobox(Tableframe,font=("arial", 12, "bold"), width=24, state="readonly")
        combo_Search["value"] = ("Mobile", "Ref")
        combo_Search.current(0)
        combo_Search.grid(row=0, column=1, padx=2)

        
        txtsearch = ttk.Entry(Tableframe,font=("arial",13,"bold"),width=20)
        txtsearch.grid(row=0, column=2, padx=2)

        btnSearch = Button(Tableframe, text="Search",font=("arial", 11, "bold"), bg="black", fg="#CD853F", width=10)
        btnSearch.grid(row=0, column=3, padx=1)

        btnShowAll = Button(Tableframe, text="Show All",font=(
            "arial", 11, "bold"), bg="black", fg="#CD853F", width=10)
    ...
    # File dialog to ask where to save the file
        ...
        # If a file path is returned from dialog
         if file:
            ...
            table_data = self.Cust_Details_Table.get_children()
            ...
            with open(file, 'w', newline='') as csvfile:
                ...
                for row in table_data:
                    row_values = self.Cust_Details_Table.item(row)["values"]
